...
from test_func.test_func_add_corp_rent_ident_in_client import add_corp_rent_ident_in_client
...
from test_func.test_func_add_password_in_client import add_password_in_client
